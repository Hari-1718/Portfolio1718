...
export const metadata: Metadata = {
  ...
  description: "Aspiring Prompt Engineer and Generative AI Specialist experienced in building MERN full-stack applications and AI/ML solutions, including recommendation systems and NLP chatbots.",
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        ...
        className={`${dancingScript.variable} ${montserrat.variable} ${roboto.variable} selection:bg-primary/20! antialiased font-montserrat h-dvh pt-16`}
      >
        <ThemeProvider
          attribute={"class"}
          defaultTheme="system"
