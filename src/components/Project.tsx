...
import { ExternalLink, Star, GitFork, FileText } from "lucide-react";
          ...
          <div className="flex gap-3 mt-auto pt-4">
            ...
            {colab ? (
              <Button
                size="sm"
                variant="outline"
                className="flex-1 gap-2 bg-gradient-to-r from-primary/10 to-secondary/10 hover:from-primary/20 hover:to-secondary/20 border-primary/20 hover:border-primary/40 text-primary transition-all duration-300"
                asChild
              >
                <Link href={colab} target="_blank">
                  <FileText className="w-4 h-4" />
                  <span className="font-medium">Colab</span>
                </Link>
              </Button>
            ) : null}
          </div>
